...
<body>
        ...
        <div class="small-form-container">
            <form id="student-login-form" class="form">
	            ...
	            <div class="form-footer">
	            	Create an account ? <a href="student-register">Register Now</a>
	            	<br/>
	            	<br/>
	            	<a href="student-forgot-password" class="fs-small">Forgot Password</a>
	            </div>
    ...
    <script src="public/js/student/student-login.js"></script>
</body>
</html>