...
public class StudentRegister extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		req.getRequestDispatcher("/student/student-register.jsp").forward(req, res);
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException {
		...
		if(firstName != null && email != null && genderId != null && dateOfBirth != null && password != null && confirmPassword != null) {
			...
			try {
				Boolean result = studentExists(email);
				if(result) {
					control = false;
			...
			if(control) {
				...
				try {
					result = addstudent(firstName, lastName, email, contact, genderId, institution, dateOfBirth, password);
				} catch (ClassNotFoundException | SQLException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
	...
	public boolean studentExists(String email) throws ClassNotFoundException, SQLException {
	...
	public boolean addstudent(String firstName, String lastName, String email, String contact, String gender, String institution, String dateOfBirth, String password) throws ClassNotFoundException, SQLException {
		DBConDao dao = new DBConDao();
		Connection con = dao.connection();

		String sql = "INSERT INTO `student` (`firstName`, `lastName`, `email`, `contact`, `gender`, `institution`, `dateOfBirth`, `password`) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
		PreparedStatement st = con.prepareStatement(sql);
